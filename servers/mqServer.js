...
(function start () {
  ...
  return Promise.resolve(true)
    ...
    .then(() => {
      app.listen(staticConfigs.mqPort, function () {
        console.warn('mQserver on: ' + staticConfigs.mqPort + '  is running ~ ')
      })
    })
    .catch(err => console.error('mQserver init error:', err))
})()

function gracefulShutDown () {
  console.warn('mQserver App exit.')
  process.exit(1)
}
